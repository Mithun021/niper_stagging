<?php
    ...
    class Student_model extends Model
    {
        ...
        protected $allowedFields = ['first_name','middle_name','last_name','enrollment_no','father_name','mother_name','date_of_birth','blood_group','personal_mail','official_mail','phone_no','gender','permanent_address','correspondence_address','category','ews','relegion','other_relegion','supervisor_name','state','city','pincode','linkedin_id','career_objective','signature','profile_image','upload_by'];
