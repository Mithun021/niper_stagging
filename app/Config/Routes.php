...
$routes->group('admin',['filter'=>'adminLogin'], static function($routes){
    ...
    $routes->get('deleteCollabGallery/(:num)', 'AcademicControllers::deleteCollabGallery/$1');
    ...
    $routes->match(['get','post'],'edit-research-publication-type/(:num)', 'AcademicControllers::edit_research_publication_type/$1');
    ...
    $routes->get('delete-awarded-faculty/(:num)', 'AchievementsController::delete_awarded_faculty/$1');
    ...
    $routes->get('delete-book-chapter-author/(:num)', 'EmployeeController::delete_book_chapter_author/$1');
    $routes->get('delete-book-chapter-coauthor/(:num)', 'EmployeeController::delete_book_chapter_coauthor/$1');
    ...
    $routes->match(['get','post'],'edit-phd-detail/(:num)', 'EmployeeController::edit_phd_detail/$1');
    $routes->get('delete-phd-detail/(:num)', 'EmployeeController::delete_phd_detail/$1');

    $routes->match(['get','post'],'mphil-ug-pg-detail', 'EmployeeController::mphil_ug_pg_detail');
    $routes->match(['get','post'],'edit-mphil-ug-pg-detail/(:num)', 'EmployeeController::edit_mphil_ug_pg_detail/$1');
    ...
    $routes->match(['get','post'],'edit-course-tought/(:num)', 'EmployeeController::edit_course_tought/$1');
    $routes->get('delete-course-tought/(:num)', 'EmployeeController::delete_course_tought/$1');

    $routes->match(['get','post'],'emp-fellowship', 'EmployeeController::emp_fellowship');
    $routes->match(['get','post'],'edit-emp-fellowship/(:num)', 'EmployeeController::edit_emp_fellowship/$1');
    ...
    $routes->match(['get','post'],'edit-employee-collaboration/(:num)', 'EmployeeController::edit_employee_collaboration/$1');
    ...
    $routes->match(['get','post'],'edit-employee-seminar-conference/(:num)', 'EmployeeController::edit_employee_seminar_conference/$1');
    $routes->get('delete-employee-seminar_conference/(:num)', 'EmployeeController::delete_employee_seminar-conference/$1');

    $routes->match(['get','post'],'employee-talk-poster', 'EmployeeController::employee_talk_poster');
    $routes->match(['get','post'],'edit-employee-talk-poster/(:num)', 'EmployeeController::edit_employee_talk_poster/$1');
    $routes->get('delete-employee-talk-poster/(:num)', 'EmployeeController::delete_employee_talk_poster/$1');

    // Adjunt Faculty Routes
    ...
    $routes->match(['get','post'],'edit-adjunt-faculty-webpage/(:num)', 'Adjunt_facultyController::edit_adjunt_faculty_webpage/$1');
    $routes->get('delete-adjunt-faculty-webpage/(:num)', 'Adjunt_facultyController::delete_adjunt_faculty_webpage/$1');

    $routes->match(['get','post'],'adjunt-faculty-notification', 'Adjunt_facultyController::adjunt_faculty_notification');
    $routes->match(['get','post'],'edit-adjunt-faculty-notification/(:num)', 'Adjunt_facultyController::edit_adjunt_faculty_notification/$1');
    $routes->get('delete-adjunt-faculty-notification/(:num)', 'Adjunt_facultyController::delete_adjunt_faculty_notification/$1');

    $routes->match(['get','post'],'adjunt-faculty-video', 'Adjunt_facultyController::adjunt_faculty_video');
    $routes->match(['get','post'],'edit-adjunt-faculty-video/(:num)', 'Adjunt_facultyController::edit_adjunt_faculty_video/$1');
    $routes->get('delete-adjunt-faculty-video/(:num)', 'Adjunt_facultyController::delete_adjunt_faculty_video/$1');
    ...
    $routes->match(['get','post'],'edit-tendor-details/(:num)', 'TendorControllers::edit_tendor_details/$1');
    $routes->get('delete-tendor-details/(:num)', 'TendorControllers::delete_tendor_details/$1');

    $routes->match(['get','post'],'tendor-page', 'TendorControllers::tendor_page');
    $routes->match(['get','post'],'edit-tendor-page/(:num)', 'TendorControllers::edit_tendor_page/$1');
    ...
    $routes->match(['get','post'],'edit-job-video/(:num)', 'JobControllers::edit_job_video/$1');
    ...
    $routes->match(['get','post'],'job_result_post/(:num)', 'JobControllers::job_result_post/$1');
    $routes->get('deleteJobPost/(:num)', 'JobControllers::deleteJobPost/$1');
    ...
    $routes->match(['get','post'],'edit-committee-details/(:num)', 'CommitteeController::edit_committee_details/$1');
    ...
    $routes->get('delete-copyright-author/(:num)', 'CopyrightController::delete_copyright_author/$1');
    ...
    $routes->get('delete-patent-webpage-file/(:num)', 'PatentController::delete_patent_webpage_file/$1');
    ...
    $routes->get('delete-convocation-session/(:num)', 'ConvocationControllers::delete_convocation_session/$1');
