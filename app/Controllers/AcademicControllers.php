...
class AcademicControllers extends BaseController
{
    ...
    public function delete_member_type_category($id){
        ...
        if ($result === true) {
            return redirect()->to('admin/academic-details')->with('msg','<div class="alert alert-success" role="alert"> Data Delete Successful </div>');
        } else {
            return redirect()->to('admin/academic-details')->with('msg','<div class="alert alert-danger" role="alert"> '.$result.' </div>');
        }
    }
