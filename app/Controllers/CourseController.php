...
class CourseController extends BaseController
{
    ...
    public function edit_assign_course($id){
        ...
        if ($this->request->is("get")) {
            ...
            $credit_score = $this->request->getVar('credit_score');
            if(empty($course_id)){
                return redirect()->to('admin/edit-assign-course')->with('status','<div class="alert alert-danger" role="alert"> Please select course </div>');
            }
            if(empty($credit_score)){
                return redirect()->to('admin/edit-assign-course')->with('status','<div class="alert alert-danger" role="alert"> Please select Credits </div>');
            }
            foreach ($course_id as $key => $value) {
                $data =[
                    'course_id' => $value,
