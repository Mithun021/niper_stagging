    ...
    <ul class="metismenu list-unstyled" id="side-menu">
        ...
        <li>
            ...
            <ul class="sub-menu" aria-expanded="false">
                ...
                <li><a href="<?= base_url() ?>admin/book-chapter" class="waves-effect"><span>Book Chapter</span></a></li>
                <li><a href="<?= base_url() ?>admin/employee-patent" class="waves-effect"><span>Emp. Patent</span></a></li>
                <li><a href="<?= base_url() ?>admin/employee-academic-details" class="waves-effect"><span>Emp. Academic Details</span></a></li>
                <li><a href="<?= base_url() ?>admin/emp-other-academic-details" class="waves-effect"><span>Other Academic Details</span></a></li>
                ...
                <li><a href="<?= base_url() ?>admin/employee-seed-money" class="waves-effect"><span>Employee Sedd Money</span></a></li>
            </ul>
        </li>
        ...
        <li>
            ...
            <ul class="sub-menu" aria-expanded="false">
                ...
                <li><a href="<?= base_url() ?>admin/facilty-services" class="waves-effect"><span>Facility Services</span></a></li>
                <li><a href="<?= base_url() ?>admin/facility-notification" class="waves-effect"><span>Facility Notification</span></a></li>
                <li><a href="<?= base_url() ?>admin/facility-banner" class="waves-effect"><span>Facility Banner</span></a></li>
                <li><a href="<?= base_url() ?>admin/facility-instruments" class="waves-effect"><span>Facility Instruments</span></a></li>
                <li><a href="<?= base_url() ?>admin/facility-section" class="waves-effect"><span>Facility Section</span></a></li>
                <li><a href="<?= base_url() ?>admin/facility-section-file" class="waves-effect"><span>Facility Section File</span></a></li>
                <li><a href="<?= base_url() ?>admin/facility-section-image" class="waves-effect"><span>Facility Section image</span></a></li>
            </ul>
        </li>
