            ...
            <form action="<?= base_url() ?>admin/alumini-page-video" method="post" enctype="multipart/form-data" id="alumini-page-notification-form">
                <div class="card-body p-1">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="video_date" class="form-control form-control-sm" required>
                    </div>
                    <div class="form-group">
                        ...
                        <tbody>
                            <?php foreach ($video as $key => $value) { ?>
                                <tr>
                                    ...
                                    <td><a href="<?= $value['video_link'] ?>" target="_blank"><?= $value['title'] ?></a></td>
                                    <td><?= $value['description'] ?></td>
                                    <td><?= $value['video_date'] ?></td>
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-sm" role="group" aria-label="Small button group">
                                            ...
                                            <a href="<?= base_url() ?>admin/delete-alumini-page-video/<?= $value['id'] ?>" class="btn btn-danger waves-effect waves-light" onclick="return confirm('Are uou sure..!')"><i class="far fa-trash-alt"></i></a>
                                        </div>
                                    </td>
                                </tr>
                            <?php } ?>
