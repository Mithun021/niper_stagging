                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-sm" role="group" aria-label="Small button group">
                                            <a href="<?= base_url() ?>admin/edit-mphil-ug-pg-detail/<?= $value['id'] ?>" class="btn btn-primary waves-effect waves-light"><i class="fas fa-pen"></i></a>
                                            <a href="<?= base_url() ?>admin/delete-mphil-ug-pg-detail/<?= $value['id'] ?>" class="btn btn-danger waves-effect waves-light" onclick="return confirm('Are you sure...!')"><i class="far fa-trash-alt"></i></a>
                                        </div>
                                    </td>
                                </tr>
                            <?php } ?>
...
function toggleRegDateField() {
    ...
    const submissionGroup = document.querySelector('.submission_date');
    const awardGroup = document.querySelector('.award_date');

    const submissionInput = document.getElementById('submission_date');
    const awardInput = document.getElementById('award_date');

    // Default: hide both and clear values
