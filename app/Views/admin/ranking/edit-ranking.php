                                ...
                                <tr>
                                    ...
                                    <td><?= $value['datasubmittedpharmacy'] ?>
                                        ...
                                        <?php if (!empty($value['pharmacy_file']) && file_exists('public/admin/uploads/ranking/' . $value['pharmacy_file'])): ?>
                                            <a href="<?= base_url() ?>public/admin/uploads/ranking/<?= $value['pharmacy_file'] ?>" target="_blank"><img src="<?= base_url() ?>public/admin/assets/images/folder.png" alt="" height="30px"></a>
                                        <?php else: ?>
                                            <img src="<?= base_url() ?>public/admin/uploads/ranking/invalid_image.png" alt="" height="40px">
                                        <?php endif; ?>
                                        <?php } ?>
                                    ...
                                    <td><?= $value['datasubmittedoverall'] ?>
                                        <?php if($value['datasubmittedoverall'] == 'yes'){ ?>
                                            ...
                                            <a href="<?= base_url() ?>public/admin/uploads/ranking/<?= $value['overall_file'] ?>" target="_blank"><img src="<?= base_url() ?>public/admin/assets/images/folder.png" alt="" height="30px"></a>
                                            <?php else: ?>
                                                <img src="<?= base_url() ?>public/admin/uploads/ranking/invalid_image.png" alt="" height="40px">
                                            <?php endif; ?>
                                        <?php } ?>
