                    ...
                    <table class="table table-striped table-hover" id="notification-datatable">
                        ...
                        <?php foreach ($adjunt_faculty_notification as $key => $value) { ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?= base_url('admin/edit-adjunt-faculty-notification/' . $value['id']) ?>" class="btn btn-sm btn-primary">Edit</a>
                                    <a href="<?= base_url('admin/delete-adjunt-faculty-notification/' . $value['id']) ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure...!')">Delete</a>
                                </td>
                            </tr>
                        <?php } ?>
                        </tbody>
