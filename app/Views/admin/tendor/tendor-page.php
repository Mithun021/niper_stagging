                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if (!empty($value['file_upload']) && file_exists('public/admin/uploads/tendor/' . $value['file_upload'])): ?>
                                        <a href="<?= base_url() ?>public/admin/uploads/tendor/<?= $value['file_upload'] ?>" target="_blank" data-toggle="tooltip" data-placement="top" title="<?= $value['file_upload_description'] ?>"><img src="<?= base_url() ?>public/admin/assets/images/pdf.png" alt="" height="30px"></a>
                                    <?php else: ?>
