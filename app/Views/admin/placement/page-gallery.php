...
<div class="row">
    <div class="col-md-4">
        <div class="card">
            ...
            <form action="<?= base_url() ?>admin/placement-page-gallery" method="post" enctype="multipart/form-data" id="alumini-page-notification-form">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if (!empty($value['file_upload']) && file_exists('public/admin/uploads/placement/' . $value['file_upload'])): ?>
                                            <a href="<?= base_url() ?>public/admin/uploads/placement/<?= $value['file_upload'] ?>" target="_blank"><img src="<?= base_url() ?>public/admin//uploads/placement/<?= $value['file_upload'] ?>" alt="" height="30px"></a>
                                        <?php else: ?>
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-sm" role="group" aria-label="Small button group">
                                            ...
                                            <a href="<?= base_url() ?>admin/delete-placement-page-gallery/<?= $value['id'] ?>" class="btn btn-danger waves-effect waves-light" onclick="return confirm('Are uou sure..!')"><i class="far fa-trash-alt"></i></a>
                                        </div>
                                    </td>
                                </tr>
                            <?php } ?>
