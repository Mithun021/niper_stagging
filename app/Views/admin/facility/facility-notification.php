        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="post" action="<?= base_url() ?>admin/facility-notification" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <span for="">Notification Title<span class="text-danger">*</span></span>
                    ...
                    <div class="form-group">
                        <span><input type="checkbox" name="marquee_status" id="" value="1">Marquee Status </span>
                    </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <table class="table table-striped table-hover" id="basic-datatable" style="width: 120%;">
                    ...
                    <tbody>
                    <?php foreach ($facility_notification as $key => $value) { ?>
                        <tr>
                            <td><?= $key+1 ?></td>
                            <td>
                            ...
                            <td><?= $value['puslish_date'] ?></td>
                            <td><?php $emp = $employee_model->get($value['upload_by']); if($emp){ echo $emp['first_name'] . " " . $emp['middle_name'] . " " . $emp['last_name']; }  ?></td>
                            <td>
                                <a href="<?= base_url() ?>admin/edit-facility-notification/<?= $value['id'] ?>" class="btn btn-sm btn-primary"><i class="fas fa-pen"></i></a>
                                <a href="<?= base_url() ?>admin/delete-facility-notification/<?= $value['id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure...!')"><i class="far fa-trash-alt"></i></a>
                            </td>
                        </tr>
                    <?php } ?>
                    </tbody>
