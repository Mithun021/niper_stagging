                ...
                <table class="table table-striped table-hover" id="basic-datatable">
                    ...
                    <?php foreach ($current_status as $key => $value) { ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?= base_url('admin/edit-current-status/'.$value['id']) ?>" class="btn btn-sm btn-primary">Edit</a>
                                <a href="<?= base_url('admin/delete-current-status/'.$value['id']) ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure..!')">Delete</a>
                            </td>
                        </tr>
                    <?php } ?>
                    </tbody>
