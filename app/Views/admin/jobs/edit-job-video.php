        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <table class="table table-striped table-hover" id="basic-datatable">
                    ...
                    <tbody>
                    <?php foreach ($job_video as $key => $value) { ?>
                        <tr>
                            <td><?= $key+1 ?></td>
                            ...
                            <td>
                                <a href="<?= base_url('admin/edit-job-video/'.$value['id']) ?>" class="btn btn-sm btn-primary">Edit</a>
                                <a href="<?= base_url('admin/delete-job-video/'.$value['id']) ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure...!')">Delete</a>
                            </td>
                        </tr>
                    <?php } ?>
                    </tbody>
