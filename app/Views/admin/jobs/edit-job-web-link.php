                ...
                <table class="table table-striped table-hover" id="basic-datatable">
                    ...
                    <?php foreach ($job_weblink as $key => $value) { ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?= base_url('admin/edit-job-web-link/'.$value['id']) ?>" class="btn btn-sm btn-primary">Edit</a>
                                <a href="<?= base_url('admin/delete-job-web-link/'.$value['id']) ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure...!')">Delete</a>
                            </td>
                        </tr>
                    <?php } ?>
                    </tbody>
