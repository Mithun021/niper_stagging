                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-sm" name="event_title" value="<?= $events_detail['title'] ?>" required minlength="5">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control form-control-sm" name="event_file" accept=".jpg, .png, .jpeg">
                      	...
                      	<div class="col-md-3">
                            <div class="form-group">
                                <span for="">Event Report(PDF)</span>
                                <input type="file" class="form-control form-control-sm" name="event_report_file" accept=".pdf">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-sm" role="group" aria-label="Small button group">
                                            ...
                                            <a href="<?= base_url() ?>admin/delete-event-post/<?= $value['id'] ?>" class="btn btn-danger waves-effect waves-light"><i class="far fa-trash-alt"></i></a>
                                        </div>
                                    </td>
                                </tr>
                            <?php } ?>
